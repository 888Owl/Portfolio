    ...
    return (
        <StyledContainer>
            ...
            <StyledInnerContainer>
                ...
                In order to get this project more traction the company then built two more tokens and websites each using React, Typescript and Ethereum. Currently these projects are staying afloat amidst the broad market of alt-coins and derivatives.
                </StyledInfo>
                </StyledInnerGrouping>
            </StyledInnerContainer>
        </StyledContainer>
